<%@page import="com.formationkilo.projetfilter.entities.*"%>
<%@page import="com.formationkilo.projetfilter.dao.*"%>
...
List<Map<Object,Object>> list = new ArrayList<Map<Object,Object>>();  
	...
	//List<Produit> lproduits
	//=(List<Produit>)request.getAttribute("list_produits");
	//ArrayList<Produit> lproduits = (ArrayList) request.getAttribute("list_produits");
   List<Produit> lproduits = (List<Produit>)request.getAttribute("list_produits");
   List<Categorie> lcategories = (List<Categorie>)request.getAttribute("list_categories");//IL fallait ajouter cat
   
   List<User> lusers = (List<User>)request.getAttribute("list_users");
   
  /* for(Categorie c:lcategories) {
	 	map = new HashMap<Object,Object>(); 
	 	map.put("label", c.getNom()); 
	 	list.add(map);
	}*/
   for(Produit p:lproduits) {
	...
	/* for(User u:lusers) {
		 	map = new HashMap<Object,Object>(); 
		 	map.put("label1", u.getNom());
		 	map.put("label2", u.getPrenom());
		 	map.put("label3", u.getEmail());
		 	map.put("label4", u.getPassword());
		 	list.add(map);
		  }*/
...
<head>
	...
	<script type="text/javascript">
			...
			data: [
			{
				...
				dataPoints: [
					<%
					 ...
					 /*List<Categorie> lcat = (List<Categorie>)request.getAttribute("list_categories");
					 for(Categorie c:lcat) {
						 out.print("{ label: '"+c.getNom()+"'  }");*/
		...
		var chart1 = new CanvasJS.Chart("chartContainer1", {
			...
			title: {
				text: "Evolution du niveau des comptes en fonction des utilisateurs"
			},
			axisY: {
				suffix: "%",
				includeZero: true
...
<body>
    ...
    -->
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="http://localhost:8080/projetfilter/Accueil" class="simple-text">
                       KILO - JAVA/EE
                    </a>
                </div>
                <ul class="nav">
